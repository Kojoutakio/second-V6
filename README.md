# Portofolio V5
Halo semuanya!
Perkenalkan, saya Kojouta, dan pada kesempatan kali ini, saya ingin berbagi proyek website portofolio yang telah saya kembangkan.
...
1. **Download project ini:**
   ...
   ```bash
   git clone https://github.com/Kojouta/Portofolio_V5.git
   ```
