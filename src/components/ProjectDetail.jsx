...
const ProjectDetails = () => {
  ...
  // Check if the img source is a video file
  const isVideo = project?.Img && (project.Img.endsWith('.mp4') || project.Img.endsWith('.webm') || project.Img.endsWith('.ogg') || project.Img.includes('video'));

  useEffect(() => {
    window.scrollTo(0, 0);
    // Use localProjects data instead of localStorage
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || 'https://github.com/Kojoutakio',
      };
